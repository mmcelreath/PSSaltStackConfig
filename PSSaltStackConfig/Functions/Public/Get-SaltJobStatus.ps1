...
function Get-SaltJobStatus {
    ...
    $returnCmdStatus = Invoke-SaltStackAPIMethod -SaltConnection $SaltConnection -Resource cmd -Method get_cmd_status -Arguments $arguments
    ...
    $returndCmdDetails = Invoke-SaltStackAPIMethod -SaltConnection $SaltConnection -Resource cmd -Method get_cmd_details -Arguments $arguments
    ...
    $returndCmd = Invoke-SaltStackAPIMethod -SaltConnection $SaltConnection -Resource cmd -Method get_cmds -Arguments $arguments
